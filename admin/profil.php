<?php include "header.php";
    // login.php den giriş yapınca gelen kullanıcı bilgilerini veritabanında eşleştiriyoruz
    // ve eşleşen değeri çekip aşağıdaki alanlara yazdırıyoruz ve güncellemek istediğimiz
    // değerleri değiştirip Kaydet butonuna bastığımızda işlem.php sayfasına bu değerleri yolluyoruz
    // ve veritabanındaki değerleri buradaki değerler ile değiştiriyoruz.
